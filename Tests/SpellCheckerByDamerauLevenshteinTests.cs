...
namespace Tests
{
    public class SpellCheckerByDamerauLevenshteinTests
    {
        [Fact]
        public void Top_Weighted_Candidates_Are_Returned_By_DamerauLevenshtein()
        {
            // Arrange
        ...
        [Fact]
        public void Top_Weighted_Candidates_Are_Returned_By_DamerauLevenshtein_Full_Word_List()
        {
            // Arrange
            HashSet<string> dictionaryWords =
                LoadDictionaryFromCsv();

            var inputWord = "sykel"; //"resturant";
